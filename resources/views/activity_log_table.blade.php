...
<div class="container-fluid mt-2">
    ...
    <div class="container-fluid">
        ...
        <table class="table table-hover" id="log_table">
            ...
            function montarAlteracoes($novo, $antigo, $fieldLabels) {
                ...
                foreach ($fieldLabels as $campo => $label) {
                    ...
                    if ($valorNovo !== null || $valorAntigo !== null) {
                        ...
                        $resultado[] = "{$label}: {$valorNovo} (antes: {$valorAntigo})";
            ...
            @foreach ($logs as $log)
                ...
                $dadosAlteracoes = montarAlteracoes($novo, $antigo, $fieldLabels);

                $resultado = $dadosAlteracoes['resultado'];
                $formatadoFinal = $dadosAlteracoes['formatadoFinal'];
                @endphp
                ...
                <tr>
                    ...
                    <td>{{ $log->log_name }}</td>
                    <td>{{ $log->properties['Pescador_nome'] ?? '----' }}</td>
